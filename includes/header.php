...
<header class="site-header">
    <div class="container nav-wrap">
        ...
        <button id="menu-toggle" class="menu-toggle" type="button" aria-expanded="false" aria-controls="main-menu">☰</button>
        ...
        <nav id="main-menu" class="menu">
            ...
            <?php if (!empty($waNumber)): ?>
                <a class="wa-btn" href="https://wa.me/<?php echo htmlspecialchars($waNumber); ?>" target="_blank" rel="noopener noreferrer">WhatsApp</a>
            <?php endif; ?>
        </nav>
    </div>
</header>
