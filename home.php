...
$services = [
    ['title' => 'Wholesale from China', 'description' => 'Bulk sourcing support with supplier negotiation and quality checks.', 'icon' => 'fa-solid fa-boxes-stacked', 'image' => 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?auto=format&fit=crop&w=700&q=80'],
    ['title' => 'Retail from China', 'description' => 'Flexible small quantity purchase for growing online sellers.', 'icon' => 'fa-solid fa-bag-shopping', 'image' => 'https://images.unsplash.com/photo-1607082350899-7e105aa886ae?auto=format&fit=crop&w=700&q=80'],
    ['title' => 'Door to Door', 'description' => 'End-to-end logistics from supplier pickup to your destination.', 'icon' => 'fa-solid fa-truck-fast', 'image' => 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=700&q=80'],
];
...
<div id="floating-cart-bar" class="floating-cart-bar" role="region" aria-label="Floating cart summary">
    <div class="floating-cart-main">
        <div>
            <p class="floating-cart-title"><i class="fa-solid fa-cart-shopping"></i> Cart <strong id="floating-count">0</strong></p>
